...
/// <summary>
/// Extrapolation (Prediction). Estimates the future position based on the calculated velocity 
/// from recent updates. Ideal for linear movement like projectiles.
/// </summary>
[RequireComponent(typeof(PhotonView))]
public class PunSyncExtrapolation : MonoBehaviourPun, IPunObservable
{
    [Range(0.0f, 2.0f)]
